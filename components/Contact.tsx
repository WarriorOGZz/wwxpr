  ...
  return (
    <section id="contact" className="pt-20 pb-10 border-t border-white/[0.06] relative z-10 bg-[#000]">
      <div className="max-w-5xl mx-auto px-6 relative">
        ...
        <div
          ref={cardRef}
          className="card-spotlight rounded-2xl p-8 md:p-12 mb-24 flex flex-col md:flex-row items-center justify-between gap-12 border border-white/[0.08] reveal-on-scroll"
        >
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-medium text-white tracking-tighter mb-4">
              Let’s Build Something Powerful
            </h2>
            <p className="text-neutral-400 mb-8 max-w-sm leading-relaxed text-sm">
              Have an idea? Need infrastructure? Want to collaborate?
              Let’s make it scalable.
            </p>

            <a
              href="mailto:support@warriorog.space"
              className="inline-flex items-center gap-2 text-white border-b border-white/30 pb-0.5 hover:text-orange-400 hover:border-orange-400 transition-all text-xs"
            >
              support@warriorog.space
          ...
          >
            <input type="hidden" name="_subject" value="New WarriorOG Contact" />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[10px] text-neutral-600 font-mono uppercase tracking-wider border-t border-white/[0.06] pt-10">
          ...
          <div className="flex items-center gap-8">
            <a
              href="https://github.com/WarriorOGZz"
              target="_blank"
            ...
            <a
              href="https://discord.com/users/1250685386666016789"
              target="_blank"
              rel="noopener noreferrer"
              className="hover:text-white transition-colors"
            >
          ...
          <div>
            © {new Date().getFullYear()} WarriorOG
          </div>
        </div>
      </div>
    </section>
